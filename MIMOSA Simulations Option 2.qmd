...
N_list <- c(10e3,25e3 ,100e3)             # Number of cells measured per sample
w_list <- c(0.25,0.5,0.75)               # Probability of being a responder
f_list<-c(1,2,10)#inflation factor
c_list <- c(1,2,10)                   # Concentration (same for all)
