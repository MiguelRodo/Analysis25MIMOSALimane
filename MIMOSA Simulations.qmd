...
```{r}
#Load functions
source("code/calculate_params.R")
source("code/simulate_data.R")
source("code/prepare_for_mimosa.R")
source("code/fit_MIMOSA.R")
source("code/average_ROC_results.R")
source("code/ROC_curve.R")
source("code/fishers_curve.R")
source("code/LRT_curve.R")
source("code/run_analysis.R")
source("code/empirical_density.R")
