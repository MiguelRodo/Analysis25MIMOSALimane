...
simulate_data_random <- function(n_samples, w, params, param_rand, N, seed = NULL) {
  ...
  # Extract random parameter values from the list
  rand_a_s <- param_rand$a_s
  rand_b_s <- param_rand$b_s
  rand_a_u_R <- param_rand$a_u_R
  rand_b_u_R <- param_rand$b_u_R
  rand_a_u_NR <- param_rand$a_u_NR
  rand_b_u_NR <- param_rand$b_u_NR
